...
use Moo 2;
use MarpaX::Grammar::Preprocessor::Parser;
...
# a callback that instantiates a parser from a given source_ref
has _MarpaX_Grammar_Preprocessor_parser_factory => (
    is => 'ro',
    init_arg => 'parser_factory',
    default => sub { \&_MarpaX_Grammar_Preprocessor_parser_factory_default },
);

sub _MarpaX_Grammar_Preprocessor_parser_factory_default {
...
sub preprocess {
    ...
    # Always buy your veggies from the local market,
    # and contribute to open source.
    #
    # Err, or maybe this just slurps a file if it is passed one.
